...
rDownloadURL = {"main": "http://gamba.dynns.com:5000/apk/xtream/2.9/main_ubuntu_18_nginx_1.20_php_7.4.tar.gz", "sub": "http://gamba.dynns.com:5000/apk/xtream/2.9/sub_ubuntu_18_nginx_1.20_php_7.4.tar.gz"}
rPackages = ["libcurl4", "libxslt1-dev", "libgeoip-dev", "e2fsprogs", "wget", "mcrypt", "nscd", "htop", "zip", "unzip", "mc", "libpng16-16", "python-paramiko", "libonig-dev" , "mariadb-server"]
...
def prepare(rType="MAIN"):
    ...
    if rType == "MAIN":
        ...
        os.system("add-apt-repository 'deb [arch=amd64,arm64,ppc64el] http://mirror.wtnet.de/mariadb/repo/10.5/ubuntu bionic main'  > /dev/null")
        os.system("apt-get update > /dev/null")
